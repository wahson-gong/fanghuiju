<?php /* Smarty version Smarty-3.1.16, created on 2017-01-31 15:23:10
         compiled from "/Users/gonghuayao/Sites/ghyCMS/application/views/home/templates/defualt/index.html" */ ?>
<?php /*%%SmartyHeaderCode:1885865522588eb89396e872-04980228%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b43f563e6afbcbb0adf19db6aef0f070e5bec5f3' => 
    array (
      0 => '/Users/gonghuayao/Sites/ghyCMS/application/views/home/templates/defualt/index.html',
      1 => 1485774855,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1885865522588eb89396e872-04980228',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_588eb8939b9e08_68857757',
  'variables' => 
  array (
    'WEB_INFO' => 0,
    'CUR_VIEW_PATH' => 0,
...
<?php if ($_valid && !is_callable('content_588eb8939b9e08_68857757')) {function content_588eb8939b9e08_68857757($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/gonghuayao/Sites/ghyCMS/application/third_party/smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
...
defualt/css/index2016.css" type="text/css" rel="stylesheet">
		<script src="<?php echo $_smarty_tpl->tpl_vars['CUR_VIEW_PATH']->value;?>
defualt/js/index2016.js" type="text/javascript"></script>
		<script>
(function(){
...
?>
					 <?php if ($_smarty_tpl->tpl_vars['banner']->value['type']=="电脑端") {?>
...
?>
				<?php if ($_smarty_tpl->tpl_vars['v']->value['type']=="电脑端") {?>
...
defualt/img/t_service.jpg" width="262" height="78" alt="<?php echo $_smarty_tpl->tpl_vars['sort1']->value[0]['parent_u1'];?>
"></a>
				</div>
...
defualt/img/t_cases.jpg" alt="<?php echo $_smarty_tpl->tpl_vars['case']->value[0]['parent_u1'];?>
...
defualt/img/t_solutions.png" alt="<?php echo $_smarty_tpl->tpl_vars['sort2']->value[0]['parent_u1'];?>
...
"><dt><a href="/index.php?c=list&sort_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" target="_blank"></a></dt>
							<dd class="t">
								<a href="/index.php?c=list&sort_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['v']->value['u1'];?>
</a>
							</dd>
...
defualt/img/t_news.jpg" alt="<?php echo $_smarty_tpl->tpl_vars['news']->value[0]['parent_u1'];?>
		...
		<div id="section6" init="false" class="section section6">
			<div class="home_partner">
				<div class="home_partner_title"  >
					<a href="/index.php?c=list&sort_id=17" target="_blank"><img src="<?php echo $_smarty_tpl->tpl_vars['CUR_VIEW_PATH']->value;?>
defualt/img/t_kehu.jpg" alt="新闻资讯" width="372" height="73"></a>
				</div>
