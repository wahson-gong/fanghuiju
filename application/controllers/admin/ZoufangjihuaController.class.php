<?php
//自动表控制器
class ZoufangjihuaController extends BaseController{
	...
	public function indexAction(){
		...
		include CUR_VIEW_PATH ."Szoufangjihua".DS. "zoufangjihua_list.html";
	}
	...
	public function addAction(){
	    ...
	    include CUR_VIEW_PATH . "Szoufangjihua" . DS ."zoufangjihua_add.html";
	}
	...
	public function editAction(){
	    ...
	    include CUR_VIEW_PATH . "Szoufangjihua" . DS . "zoufangjihua_edit.html";
	...
	public function insertAction(){
	    ...
	    if ($tableModel->insert($data)) {
	        $this->jump('index.php?p=admin&c=zoufangjihua&a=index&model_id='.$model_id,'添加成功',2);
	    } else {
	        $this->jump('index.php?p=admin&c=zoufangjihua&a=add&model_id='.$model_id,'添加失败');
	    }
	...
	public function updateAction(){
	    ...
	    if($tableModel->update($data)){
	        $this->jump('index.php?p=admin&c=zoufangjihua&a=index&model_id='.$model_id,"更新成功",2);
	    }else{
	        $this->jump('index.php?p=admin&c=zoufangjihua&a=edit&id='.$data['id'].'&model_id='.$model_id,"更新失败",2);
	    }
	}
	...
	public function deleteAction(){
	    ...
	    if($_REQUEST['id']=='')
	    {
	        $this->jump('index.php?p=admin&c=zoufangjihua&a=index&model_id='.$model_id,"删除失败，参数不能为空",3);
	    }
	    $sys_id = $_REQUEST['id'];
	    ...
	    if ($tableModel->delete($array_id)!="false") {
	        $this->jump('index.php?p=admin&c=zoufangjihua&a=index&model_id='.$model_id, "删除成功", 2);
	    } else {
	        $this->jump('index.php?p=admin&c=zoufangjihua&a=index&model_id='.$model_id, "删除失败", 3);
	    }
	}
}